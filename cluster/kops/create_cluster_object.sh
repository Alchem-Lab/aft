...
kops create cluster --master-size t2.micro --zones us-west-1a --ssh-public-key ${SSH_KEY}.pub ${HYDRO_CLUSTER_NAME} --networking weave --topology private > /dev/null 2>&1
